...
while running_programme:
    total_current_minutes = int((total_donation / standar_donation) * 60)
    ...
    if total_current_minutes < target_minutes:
        ...
        while True:
            pilihan_user = input('Apakah ingin "selesai" atau "tambah_jam"? Ketik pilihanmu: ').lower()
            ...
            if pilihan_user == "selesai":
                ...
                additional_hours = int(input("Masukkan berapa jam additional_hours targetmu: "))
